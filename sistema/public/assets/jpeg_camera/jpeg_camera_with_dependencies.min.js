...
(function() {
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o = {}.hasOwnProperty,
        p = function(a, b) {
            function c() {
                this.constructor = a
            }
    ...
    if (a = function() {
            function a(a, b) {
                if ("string" == typeof a && (a = document.getElementById(a.replace("#", ""))), !a || !a.offsetWidth) throw "JpegCamera: invalid container";
            ...
            return a.DefaultOptions = {
                shutter_ogg_url: "https://maequeacolhe.com.br/sistema/public/assets/jpeg_camera/shutter.ogg",
                shutter_mp3_url: "https://maequeacolhe.com.br/sistema/public/assets/jpeg_camera/shutter.mp3",
                swf_url: "https://maequeacolhe.com.br/sistema/public/assets/jpeg_camera/jpeg_camera.swf",
                on_debug: function(a) {
                ...
                for (a in c) b = c[a], this._engine_discard(b), b._discarded = !0;
            ...
            var a;
            if (a = document.createElement("canvas"), a.getContext && !a.toBlob) throw "JpegCamera: Canvas-to-Blob is not loaded"
            ...
            return p(c, b), c.prototype._engine_init = function() {
                ...
                this._debug("Using HTML5 engine"), j = Math.floor(.2 * this.view_height), e = Math.floor(.2 * this.view_width), this.message = document.createElement("div"), this.message["class"] = "message", this.message.style.width = "100%", this.message.style.height = "100%", a._add_prefixed_style(this.message, "boxSizing", "border-box"), this.message.style.overflow = "hidden", this.message.style.textAlign = "center", this.message.style.paddingTop = "" + j + "px", this.message.style.paddingBottom = "" + j + "px", this.message.style.paddingLeft = "" + e + "px", this.message.style.paddingRight = "" + e + "px", this.message.style.position = "absolute", this.message.style.zIndex = 3, this.message.innerHTML = "Please allow camera access when prompted by the browser.<br><br>Look for camera icon around your address bar.", this.container.appendChild(this.message), this.video_container = document.createElement("div"), this.video_container.style.width = "" + this.view_width + "px", this.video_container.style.height = "" + this.view_height + "px", this.video_container.style.overflow = "hidden", this.video_container.style.position = "absolute", this.video_container.style.zIndex = 1, this.container.appendChild(this.video_container), this.video = document.createElement("video"), this.video.autoplay = !0, a._add_prefixed_style(this.video, "transform", "scalex(-1.0)"), window.AudioContext && (f(l) ? this._load_shutter_sound(this.options.shutter_ogg_url) : f(i) && this._load_shutter_sound(this.options.shutter_mp3_url)), d = {
                    ...
                    return h._remove_message(), window.URL ? h.video.src = URL.createObjectURL(a) : h.video.src = a, h._block_element_access(), h._wait_for_video_ready()
                }, c = function(a) {
                    var b, c, d;
                    ...
                    for (c in a)
                        if (d = a[c], "code" !== c) return void h._got_error(c);
                ...
                var a;
                if (this.shutter_buffer) return a = this.audio_context.createBufferSource(), a.buffer = this.shutter_buffer, a.connect(this.audio_context.destination), a.start(0)
                ...
                var b, c;
                if (!this.audio_context) return this.audio_context = new AudioContext, b = new XMLHttpRequest, b.open("GET", a, !0), b.responseType = "arraybuffer", c = this, b.onload = function() {
        ...
        }(a), window.JpegCamera = c), !window.swfobject) throw "JpegCamera: SWFObject is not loaded";
    k = "9", j = !window.JpegCamera || !window.AudioContext || window.jpeg_camera_force_flash, g = function() {
        ...
        return p(c, b), c._send_message = function(a, b) {
            ...
            for (f = this._flash._get_image_data(b.id), a.canvas_supported() ? (d = document.createElement("canvas"), d.width = f.width, d.height = f.height, e = d.getContext("2d"), l = e.createImageData(f.width, f.height)) : l = {
                    ...
                    width: f.width,
                    height: f.height
                }, o = f.data, h = m = 0, n = o.length; n > m; h = ++m) j = o[h], i = 4 * h, k = j >> 16 & 255, g = j >> 8 & 255, c = 255 & j, l.data[i + 0] = k, l.data[i + 1] = g, l.data[i + 2] = c, l.data[i + 3] = 255;
            return l
        }, c.prototype._engine_get_blob = function(a, b, c, d, e) {
            var f, g;
        ...
        return b._next_snapshot_id = 1, b.prototype._discarded = !1, b.prototype.show = function() {
            ...
            var b;
            if (null == a && (a = {}), this._discarded && raise("discarded snapshot cannot be used"), this._uploading) return void this.camera._debug("Upload already in progress");
            if (this._uploading = !0, this._retry = 1, this._upload_options = a, b = this._options(), !b.api_url) throw this.camera._debug("Snapshot#upload called without valid api_url"), "Snapshot#upload called without valid api_url";
            ...
            if (!this._stats) {
                for (i = a.width * a.height, j = 0, d = new Array(i), f = l = 0; i > l; f = l += 1) g = 4 * f, c = .2126 * a.data[g + 0] + .7152 * a.data[g + 1] + .0722 * a.data[g + 2], c = Math.round(c), j += c, d[f] = c;
                for (h = Math.round(j / i), k = 0, m = 0, n = d.length; n > m; m++) c = d[m], k += Math.pow(c - h, 2);
