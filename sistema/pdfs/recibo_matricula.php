<?php
	...
	if(isset($_POST['gerar_recibo'])){
        ...
        $e = '<html>
			<head>
				<meta charset="utf-8">
				<title>Recibo de Pagamento de Matrícula</title>
            ...
            $e .= "<div id='conteudo'>";
            $e .= "<h2 align='center'>Recibo de Pagamento de Matrícula</h2> <br />";

            $e .= "<table width='100%' align='center' class='no-border'>";
            $e .= "<tr>";
            if(isset($duas_vias) && $duas_vias == 'sim'){
            	$e .= "<td align='left'><u>Matrícula Nº #". $id_mensalidade ." - 1a Via</u></td>";
            } else {
            	$e .= "<td align='left'><u>Matrícula Nº #". $id_mensalidade ."</u></td>";
            }
			...
			if(isset($duas_vias) && $duas_vias == 'sim'){
	            ...
	            $e .= "<h2 align='center'>Recibo de Matrícula</h2> <br />";

	            $e .= "<table width='100%' align='center' class='no-border'>";
	            $e .= "<tr>";
	            $e .= "<td align='left'><u>Matrícula Nº #". $id_mensalidade ." - 2a Via</u></td>";
            	$e .= "<td align='right' width='10%' style='border: 1px solid #000; padding: 6px;'><strong>R$". number_format($valor, 2, ',', '.') ."</strong></td>";
	            $e .= "</tr>";
				$e .= "</table>";
        ...
        /* Exibe */
        $dompdf->stream(
            "RECIBO DE PAGAMENTO DE MATRICULA #". $id_mensalidade .".pdf", /* Nome do arquivo de saída */
            array(
