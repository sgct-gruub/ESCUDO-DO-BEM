<?php
	...
	session_start();
		...
		$data_hoje = date('d') . ' de ' . $nome_mes . ' de ' . date('Y');
            ...
            $e .= "<div id='head'></div>";
            $e .= "<h2 align='center' style='margin-bottom: -20px;'>LISTA DE CHAMADA - ".$unidade['nome']."</h2> <br />";
            ...
            $e .= "<td style='text-align: center'>CAFÉ M</td>";
            $e .= "<td style='text-align: center'>ESP</td>";
            $e .= "<td style='text-align: center'>LABORTERAPIA</td>";
            $e .= "<td style='text-align: center'>SPH</td>";
            $e .= "<td style='text-align: center'>ALMOÇO</td>";
            $e .= "<td style='text-align: center'>REUNIÃO T</td>";
            $e .= "<td style='text-align: center'>CAFÉ T</td>";
            $e .= "<td style='text-align: center'>JANTAR</td>";
            $e .= "</tr>";
            $e .= "</thead>";
            $e .= "<tbody>";
