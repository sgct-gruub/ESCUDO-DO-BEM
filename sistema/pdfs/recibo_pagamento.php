<?php
	...
	if(isset($_POST['gerar_recibo'])){
        ...
        $e = '<html>
            ...
            $e .= "<div id='conteudo'>";
            $e .= "<h2 align='center'>Recibo de Pagamento</h2> <br />";

            $e .= "<table width='100%' align='center' class='no-border'>";
            $e .= "<tr>";
            if(isset($duas_vias) && $duas_vias == 'sim'){
            	$e .= "<td align='left'><u>Pagamento Nº #". $id_pagamento ." - 1a Via</u></td>";
            } else {
            	$e .= "<td align='left'><u>Pagamento Nº #". $id_pagamento ."</u></td>";
            }
			...
			if(isset($duas_vias) && $duas_vias == 'sim'){
	            ...
	            $e .= "<table width='100%' align='center' class='no-border'>";
	            $e .= "<tr>";
	            $e .= "<td align='left'><u>Pagamento Nº #". $id_pagamento ." - 2a Via</u></td>";
            	$e .= "<td align='right' width='10%' style='border: 1px solid #000; padding: 6px;'><strong>R$". number_format($valor, 2, ',', '.') ."</strong></td>";
	            $e .= "</tr>";
				$e .= "</table>";
        ...
        /* Exibe */
        $dompdf->stream(
            "RECIBO DE PAGAMENTO #". $id_pagamento .".pdf", /* Nome do arquivo de saída */
            array(
